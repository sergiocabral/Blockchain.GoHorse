...
import { Lock } from '@gohorse/npm-bus';
...
export class BotTwitchApplication extends Application<BotTwitchConfiguration> {
  ...
  public constructor() {
    ...
    this.busConnection = new BusConnection(
      ...
      [ExchangeCoinMessage, UserMessageDeliveryReceipt],
  ...
  private handleTwitchMessage(
    ...
    if (userCommand !== undefined) {
      const user = new UserModel('twitch', {
        id: message.userstate['user-id'],
        name: message.userstate.username
      });
      ...
      switch (message.status) {
        ...
        default:
          throw new NotImplementedError(
            `The delivery status was not implemented.`
          );
      }
